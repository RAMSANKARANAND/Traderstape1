/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=D:\traderstape\wrangler.jsonc --env-interface=CloudflareEnv D:\traderstape\cloudflare-env.d.ts` (hash: c4f9be3ce15a93afacfdc0f6ef9c994b)
// Runtime types generated with workerd@1.20260721.1 2026-07-23 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	traderstape: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	TURSO_DATABASE_URL: "libsql://traderstape-ramsankaranand.aws-ap-south-1.turso.io";
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* traderstape1new */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURSO_DATABASE_URL" | "NEXTJS_ENV">> {}
}
